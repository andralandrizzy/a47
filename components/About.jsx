    ...
    return (
        <section id="about" className="bg-white grid w-full dark:bg-gray-900">
            <div className="lg:max-w-[83.33%] p-5 mx-auto text-center">
                ...
                <div className="aboutContent flex flex-col text-start items-center">
                    <p className="py-4 leading-[32px] lg:w-[800px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto consequuntur,
                    ...
                    <div className="lg:flex my-6 gap-6 justify-between lg:items-start">
                        ...
                        <div className="lg:w-[800px] leading-[32px] lg:px-[3rem]">
                            <p>
