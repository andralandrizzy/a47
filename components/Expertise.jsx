        ...
        <section id="services" className="bg-white w-full dark:bg-gray-900 mx-auto">
            <div className="max-w-screen-xl mx-auto p-4">
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-[2.5rem] py-8">
                    <div className="flex flex-col lg:items-center justify-center lg:w-[250px] pb-4 border-b-2 border-[#2855c0]">
                    ...
                    <div className="flex flex-col lg:items-center justify-center lg:w-[250px] pb-4 border-b-2 border-[#e76127]">
                    ...
                    <div className="flex flex-col lg:items-center justify-center lg:w-[250px] pb-4 border-b-2 border-[#e1de2b]">
                    ...
                    <div className="flex flex-col lg:items-center justify-center lg:w-[250px] pb-4 border-b-2 border-[#5d3b78]">
